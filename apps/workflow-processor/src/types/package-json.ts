...
export type JSONSchemaForNPMPackageJsonFiles = JSONSchemaForNPMPackageJsonFiles1 &
  JSONSchemaForNPMPackageJsonFiles2;
...
export type ArrayStringRule = (
  | (null | string)
  | [
      (([] | unknown) | SimpleArrayStringRule | CoreRule) &
        (
          | ((([] | unknown) | SimpleArrayStringRule | CoreRule) & string)
          | ((([] | unknown) | SimpleArrayStringRule | CoreRule) & unknown[])
          | (([] | unknown) | SimpleArrayStringRule | CoreRule)
        ),
      ...((([] | unknown) | SimpleArrayStringRule | CoreRule) &
        (
...
export type LowerUpperRule = (
  ...
  | ("lower" | "upper" | [])
  | [
      (("lower" | "upper" | unknown) | CoreRule) &
        (
          | ((("lower" | "upper" | unknown) | CoreRule) & string)
          | (("lower" | "upper" | unknown) | CoreRule)
        ),
      (("lower" | "upper" | unknown) | CoreRule) &
        (
...
export type AlwaysMultiLineRule = (
  ...
  | [
      (("always" | "always-multi-line" | unknown) | CoreRule) &
        (
          | ((("always" | "always-multi-line" | unknown) | CoreRule) & string)
          | (("always" | "always-multi-line" | unknown) | CoreRule)
        ),
      (("always" | "always-multi-line" | unknown) | CoreRule) &
        (
...
export type BooleanRule = (
  ...
  | (true | [])
  | [
      ((true | unknown) | CoreRule) &
        ((((true | unknown) | CoreRule) & boolean) | ((true | unknown) | CoreRule)),
      ((true | unknown) | CoreRule) &
        ((((true | unknown) | CoreRule) & boolean) | ((true | unknown) | CoreRule))
    ]
) &
...
export type NewlineRule = (
  ...
  | [
      (("always" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) &
        (
          | ((("always" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) & string)
          | (("always" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule)
        ),
      (("always" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) &
        (
...
export type AlwaysNeverRule = (
  ...
  | [
      (("always" | "never" | unknown) | CoreRule) &
        (
          | ((("always" | "never" | unknown) | CoreRule) & string)
          | (("always" | "never" | unknown) | CoreRule)
        ),
      (("always" | "never" | unknown) | CoreRule) &
        (
...
export type StringRule = (
  | (null | string)
  | [
      (unknown | CoreRule) & (((unknown | CoreRule) & string) | (unknown | CoreRule)),
      (unknown | CoreRule) & (((unknown | CoreRule) & string) | (unknown | CoreRule))
    ]
) &
  (
...
export type SpaceRule = (
  ...
  | [
      (("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule) &
        (
          | ((
              | ("always" | "never" | "always-single-line" | "never-single-line" | unknown)
              | CoreRule
            ) &
              string)
          | (("always" | "never" | "always-single-line" | "never-single-line" | unknown) | CoreRule)
...
export type IntegerRule = (
  | (null | number)
  | [
      (unknown | CoreRule) & (((unknown | CoreRule) & number) | (unknown | CoreRule)),
      (unknown | CoreRule) & (((unknown | CoreRule) & number) | (unknown | CoreRule))
    ]
) &
  (
...
export type SingleDoubleRule = (
  ...
  | ("single" | "double" | [])
  | [
      (("single" | "double" | unknown) | CoreRule) &
        (
          | ((("single" | "double" | unknown) | CoreRule) & string)
          | (("single" | "double" | unknown) | CoreRule)
        ),
      (("single" | "double" | unknown) | CoreRule) &
        (
...
export interface AtRule {
  ...
  "at-rule-name-space-after"?: (
    ...
    | [
        (("always" | "always-single-line" | unknown) | CoreRule) &
          (
            | ((("always" | "always-single-line" | unknown) | CoreRule) & string)
            | (("always" | "always-single-line" | unknown) | CoreRule)
          ),
        (("always" | "always-single-line" | unknown) | CoreRule) &
          (
  ...
  "at-rule-semicolon-newline-after"?: (
    ...
    | ("always" | [])
    | [
        (("always" | unknown) | CoreRule) &
          (((("always" | unknown) | CoreRule) & string) | (("always" | unknown) | CoreRule)),
        (("always" | unknown) | CoreRule) &
          (((("always" | unknown) | CoreRule) & string) | (("always" | unknown) | CoreRule))
      ]
  ) &
      ...
      | (null &
          (
            ...
            | [
                (("always" | unknown) | CoreRule) &
                  (
                    | ((("always" | unknown) | CoreRule) & string)
                    | (("always" | unknown) | CoreRule)
                  ),
                (("always" | unknown) | CoreRule) &
                  (((("always" | unknown) | CoreRule) & string) | (("always" | unknown) | CoreRule))
...
export interface Block {
  ...
  "block-closing-brace-empty-line-before"?: (
    ...
    | [
        (("always-multi-line" | "never" | unknown) | CoreRule) &
          (
            | ((("always-multi-line" | "never" | unknown) | CoreRule) & string)
            | (("always-multi-line" | "never" | unknown) | CoreRule)
          ),
        (("always-multi-line" | "never" | unknown) | CoreRule) &
          (
...
export interface Color {
  ...
  "color-hex-length"?: (
    ...
    | ("short" | "long" | [])
    | [
        (("short" | "long" | unknown) | CoreRule) &
          (
            | ((("short" | "long" | unknown) | CoreRule) & string)
            | (("short" | "long" | unknown) | CoreRule)
          ),
        (("short" | "long" | unknown) | CoreRule) &
          (
  ...
  "color-named"?: (
    ...
    | [
        (("always-where-possible" | "never" | unknown) | CoreRule) &
          (
            | ((("always-where-possible" | "never" | unknown) | CoreRule) & string)
            | (("always-where-possible" | "never" | unknown) | CoreRule)
          ),
        (("always-where-possible" | "never" | unknown) | CoreRule) &
          (
...
export interface Declaration {
  ...
  "declaration-colon-space-after"?: (
    ...
    | [
        (("always" | "never" | "always-single-line" | unknown) | CoreRule) &
          (
            | ((("always" | "never" | "always-single-line" | unknown) | CoreRule) & string)
            | (("always" | "never" | "always-single-line" | unknown) | CoreRule)
          ),
        (("always" | "never" | "always-single-line" | unknown) | CoreRule) &
          (
...
export interface DeclarationBlock {
  ...
  "declaration-block-properties-order"?: (
    ...
    | ("alphabetical" | [])
    | [
        (("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) &
          (
            | ((("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) &
                string)
            | ((("alphabetical" | [] | unknown) | string | SimpleArrayStringRule | CoreRule) &
...
export interface Font {
  ...
  "font-weight-notation"?: (
    ...
    | [
        (("numeric" | "named-where-possible" | unknown) | CoreRule) &
          (
            | ((("numeric" | "named-where-possible" | unknown) | CoreRule) & string)
            | (("numeric" | "named-where-possible" | unknown) | CoreRule)
          ),
        (("numeric" | "named-where-possible" | unknown) | CoreRule) &
          (
...
export interface GeneralSheet {
  ...
  indentation?: (
    ...
    | [number, ...number[]]
    | [
        (number | ("tab" | unknown) | CoreRule) &
          (
            | ((number | ("tab" | unknown) | CoreRule) & number)
            | ((number | ("tab" | unknown) | CoreRule) & string)
            | (number | ("tab" | unknown) | CoreRule)
          ),
        (number | ("tab" | unknown) | CoreRule) &
          (
...
export interface Rule {
  ...
  "rule-nested-empty-line-before"?: (
    ...
    | [
        (("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule) &
          (
            | ((
                | ("always" | "never" | "always-multi-line" | "never-multi-line" | unknown)
                | CoreRule
              ) &
                string)
            | (("always" | "never" | "always-multi-line" | "never-multi-line" | unknown) | CoreRule)
...
export interface StylelintDisableComment {
  ...
  "stylelint-disable-reason"?: (
    ...
    | [
        (("always-before" | "always-after" | unknown) | CoreRule) &
          (
            | ((("always-before" | "always-after" | unknown) | CoreRule) & string)
            | (("always-before" | "always-after" | unknown) | CoreRule)
          ),
        (("always-before" | "always-after" | unknown) | CoreRule) &
          (
